  ...
  async create(dto: CreateObligationDto) {
    ...
    return this.prisma.financialObligation.create({
      data: {
        ...
        status: 'UNPAID',
        loanStatus: dto.loanStatus || 'Approved',
        approvedAmount: dto.approvedAmount || dto.originalAmount,
        disbursedAmount: 0,
        remainingLoanAmount: dto.approvedAmount || dto.originalAmount,
        beneficiaryName: dto.beneficiaryName || member.name,
        beneficiaryBank: dto.beneficiaryBank || 'BDO',
        beneficiaryAccount: dto.beneficiaryAccount || '00123456789',
        fundSource: dto.fundSource || 'General Fund',
      },
      include: {
