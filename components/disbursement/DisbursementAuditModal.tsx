...
import { 
  X, FileText, Download, Shield, Clock, ArrowRight, User, Banknote
} from 'lucide-react';
...
export default function DisbursementAuditModal({ isOpen, onClose, disbursement, showToast }: Props) {
  ...
  const handleExportLog = () => {
    const logContent = `DISBURSEMENT AUDIT LOG - ${disbursement.ref}\nGenerated on: ${new Date().toISOString()}\n\n` + 
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-white/60 pb-4 mb-5 gap-4">
          <div>
            ...
            <div className="flex items-center gap-2 mt-1.5">
              ...
              <span className="text-[12px] font-medium text-[#04152d]/60">Ref: {disbursement.ref}</span>
            </div>
          </div>
          ...
          {activeTab === 'details' && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="bg-white/40 p-5 rounded-[16px] border border-white/80">
                <h4 className="text-[12px] font-semibold text-[#04152d]/60 uppercase tracking-widest mb-4 border-b border-white/60 pb-2">Request Data</h4>
                <div className="grid grid-cols-2 gap-y-4 text-[13px]">
                  ...
                  <div className="space-y-1">
                    <p className="font-medium text-[#04152d]/60">Disbursement Method:</p>
                    <p className="font-semibold text-[#04152d]">{disbursement.method}</p>
                  </div>
                  <div className="space-y-1">
                ...
                <div className="bg-emerald-50/50 p-5 rounded-[16px] border border-emerald-100 animate-fade-in">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center text-[13px]">
                      ...
                      <span className="font-semibold text-emerald-900 font-mono bg-white/60 px-2 py-0.5 rounded border border-emerald-200">{disbursement.executionRef}</span>
                    </div>
                    <div className="flex justify-between items-center text-[13px]">
